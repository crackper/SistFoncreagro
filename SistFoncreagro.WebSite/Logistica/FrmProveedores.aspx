<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmProveedores.aspx.vb" Inherits="SistFoncreagro.WebSite.FrmProveedores" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
<script type="text/javascript">
    function CargarVentanaProveedor(id, tipo) {
        var oWnd = radopen("VentanaProveedor.aspx?id=" + id + "&tip=" + tipo, "EditarProveedor");
    }

    function NuevoProveedor() {
        var oWnd = radopen("VentanaProveedor.aspx", "NuevoProveedor");
        return false;
    }
    ...
    <div style="width: 931px; margin-left: 0px">
        <fieldset>
                <legend style="font-family: Arial; font-size: 15px; width: 100px;">Proveedores
                </legend>
               <div style="height: 570px; overflow: scroll; width: 900px;" class="grid">

    <telerik:RadGrid ID="RadGrid2" runat="server" 
        AllowPaging="True" AllowFilteringByColumn="True"
                        AutoGenerateColumns="False" CellSpacing="0" DataSourceID="odsProveedores" 
...
<MasterTableView datasourceid="odsProveedores" pagesize="15" CommandItemDisplay="Top" 
                            NoMasterRecordsText="No existen registros." 
                            DataKeyNames="IdProveedorCliente">
<CommandItemSettings ExportToPdfText="Exportar a PDF" 
        AddNewRecordText="Nuevo Proveedor"  RefreshText="Refrescar" ></CommandItemSettings>
...
<Columns>
       ...
       <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Anular" 
          ...
          <ItemStyle CssClass="cursor" HorizontalAlign="Center" Width="20px" />
            ...
            FilterControlAltText="filtro40" HeaderText="Ruc" 
            SortExpression="Ruc" UniqueName="TemplateColumn40" 
        ...
        <telerik:GridBoundColumn DataField="RazonSocial" 
            FilterControlAltText="filtro2" HeaderText="Razón Social" 
            SortExpression="RazonSocial" UniqueName="TemplateColumn2" 
            AndCurrentFilterFunction="Contains" AutoPostBackOnFilter="True" 
            CurrentFilterFunction="Contains" ShowFilterIcon="False" 
        ...
        <telerik:GridBoundColumn DataField="Rubro" 
            FilterControlAltText="filtro4" HeaderText="Rubro" 
            SortExpression="Rubro" UniqueName="TemplateColumn4" 
            AndCurrentFilterFunction="Contains" AutoPostBackOnFilter="True" 
            CurrentFilterFunction="Contains" ShowFilterIcon="False" 
...
<HeaderContextMenu CssClass="GridContextMenu GridContextMenu_Default"></HeaderContextMenu>
      ...
      <asp:Label ID="lblTipoCatalogo" runat="server" Text="0" Visible="False" 
        ForeColor="White"></asp:Label>
    <asp:ObjectDataSource ID="odsProveedores" runat="server" 
                    SelectMethod="GetAllFromProveedorClienteByTipo" 
                    TypeName="SistFoncreagro.BussinesLogic.ProveedorClienteBL" 
        OldValuesParameterFormatString="original_{0}">
        <SelectParameters>
            <asp:ControlParameter ControlID="TextBox1" Name="tipo" PropertyName="Text" 
                Type="Int32" />
        </SelectParameters>
    ...
    <asp:TextBox 
                        ID="TextBox1" runat="server" Height="0px" ReadOnly="True" 
        Visible="False" Width="0px">1</asp:TextBox>
    <br />
    <telerik:RadWindowManager ID="RadWindowManager2" runat="server">
       <Windows>
              <telerik:RadWindow ID="NuevoProveedor" runat="server" Title="NUEVO PROVEEDOR" Height="470px"
                        Width="811px" Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false"
                        Modal="true" Animation="Resize" />
              <telerik:RadWindow ID="EditarProveedor" runat="server" Title="EDITAR PROVEEDOR" Height="470px"
                        Width="811px" Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false"
                        Modal="true" Animation="Resize" />                         
              </Windows>
