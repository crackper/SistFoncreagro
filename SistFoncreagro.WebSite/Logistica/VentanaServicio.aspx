<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VentanaServicio.aspx.vb" Inherits="SistFoncreagro.WebSite.VentanaServicio" %>
...
<fieldset>
   <legend style="font-family: Arial; font-size: 15px;">
       <asp:Label ID="lbTitulo" runat="server">EDITAR SERVICIO</asp:Label>
    </legend>
    <table style="width: 100%;">
        <tr>
            <td style="width: 20%; font-size: 17px;" class="style1">
                <asp:Label ID="lblTituloNumero" runat="server">Codigo :</asp:Label>
            </td>
            <td style="width: 49%;">
