...
Public Class ControlSustento
    ...
    Protected Sub Page_DataBinding(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.DataBinding
        ...
        Else
            ...
            Me.TextBox4.Text = DataBinder.Eval(DataItem, "Descripcion")
    ...
    Protected Sub ibSubirArchivo_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ibSubirArchivo.Click
        ...
        If (fileExt = ".doc" Or fileExt = ".pdf" Or fileExt = ".docx" Or fileExt = ".gif" Or fileExt = ".ppt" Or fileExt = ".pptx") Then
            archivo = SaveFile(FileUploadControl.PostedFile, "~\Monitoreo\Adjuntos\", "", FileUploadControl)
        ...
        Else
            ...
            Me.lblMsn.Text = "Solo se permiten archivos de formato .doc, .docx, .pdf, ppt, pptx o .Gif"
        End If
    End Sub
