Public Class ParamRepMovCtaProveedores
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        cadena_java = "<script type='text/javascript'> " & _
                                     " window.open('ReporteMovCtaProveedores.aspx?fechaInicio=" + Me.RadDatePicker1.SelectedDate.ToString + "&fechaFin=" + Me.RadDatePicker2.SelectedDate.ToString + "&Idmoneda=" + Me.RadioButtonList1.SelectedValue + "&idProyecto=" + idProyecto.ToString + "&idProveedor=" + idProveedor.ToString + "&estado=" + Me.DropDownList1.SelectedValue.ToString + "' ); " & _
                                     Chr(60) & "/script>"
