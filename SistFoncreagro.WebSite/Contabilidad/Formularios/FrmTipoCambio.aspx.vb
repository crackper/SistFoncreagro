...
Public Class RegTipoCambioDet
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim tc As Decimal
            ...
            If IdTipoCambio > 0 Then
                IdTipoCambio = Request.QueryString("IdtipoCambio")
                _TipoCambio = TipoCambioBL.GetTIPOCAMBIOByIdTipCambio(IdTipoCambio)
                mes = _TipoCambio.Mes
                If mes = Session("Mes") Then
                    dia = Session("Dia")
                Else
                    dia = 31
                End If
    ...
    Protected Sub ImageButton2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton2.Click
        ...
        Response.Redirect("FrmTipoCambio.aspx?IdTipoCambio=" + id.ToString)
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        Response.Redirect("ListaTipoCambio.aspx")
