<%@ Page Title="Estado de Flujo de Efectivo" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contabilidad/MasterPageContabilidad.master" CodeBehind="ParamRepFlujoEfectivo.aspx.vb" Inherits="SistFoncreagro.WebSite.ParamRepFlujoEfectivo" %>
                ...
                <table class="fondoTabla" style="background-color: #0C3B2A; color: #FFFFFF;">
                    <tr class="Titulos">
                        <td class="Titulos" style="font-family: Arial; font-size: 10pt">
                            &nbsp;PARÁMETROS PARA MOSTRAR&nbsp; el estado de flujo de efectivo</td>
                        <td>
                            &nbsp;</td>
