<%@ Page Title="Balance de Comprobación" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contabilidad/MasterPageContabilidad.master" CodeBehind="BalanceComprobacion.aspx.vb" Inherits="SistFoncreagro.WebSite.BalanceComprobacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <telerik:RadGrid ID="RadGrid1" runat="server" DataSourceID="Nivel1" 
        CellSpacing="0" GridLines="None" AutoGenerateColumns="False" Skin="Hay">
<MasterTableView DataSourceID="Nivel1" ClientDataKeyNames="CodigoN1" 
            DataKeyNames="CodigoN1" NoDetailRecordsText="No existen registros." 
            NoMasterRecordsText="No existen registros." ShowFooter="True">
    <DetailTables>
        <telerik:GridTableView runat="server" ClientDataKeyNames="CodigoN2" 
            DataKeyNames="CodigoN2" DataSourceID="Nivel2" Name="Nivel2" 
            NoDetailRecordsText="No existen registros." 
            NoMasterRecordsText="No existen registros.">
            <DetailTables>
                <telerik:GridTableView runat="server" ClientDataKeyNames="CodigoN3" 
                    DataKeyNames="CodigoN3" DataSourceID="Nivel3" Name="Nivel3" 
                    NoDetailRecordsText="No existen registros." 
                    NoMasterRecordsText="No existen registros.">
                    <ParentTableRelation>
                        <telerik:GridRelationFields DetailKeyField="CodigoN2" 
                            MasterKeyField="CodigoN2" />
                    </ParentTableRelation>
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="CodigoN3" 
                            FilterControlAltText="Filter CodigoN3 column" HeaderText="Cuenta" ReadOnly="True" 
                            SortExpression="CodigoN3" UniqueName="CodigoN3">
            ...
            <ParentTableRelation>
                <telerik:GridRelationFields DetailKeyField="CodigoN1" 
                    MasterKeyField="CodigoN1" />
            </ParentTableRelation>
            <CommandItemSettings ExportToPdfText="Export to PDF" />
            <RowIndicatorColumn FilterControlAltText="Filter RowIndicator column">
                <HeaderStyle Width="20px" />
            ...
            <Columns>
                   <telerik:GridBoundColumn DataField="CodigoN2" 
                        FilterControlAltText="Filter CodigoN2 column" HeaderText="Cuenta" ReadOnly="True" 
                        SortExpression="CodigoN2" UniqueName="CodigoN2">
                        <HeaderStyle HorizontalAlign="Center" Font-Names="Arial" Font-Size="8pt" 
                            Width="6%" />
                        <ItemStyle Font-Names="Arial" Font-Size="8pt" />
                    </telerik:GridBoundColumn>
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
         <telerik:GridBoundColumn DataField="CodigoN1" 
            FilterControlAltText="Filter CodigoN1 column" HeaderText="Cuenta" ReadOnly="True" 
            SortExpression="CodigoN1" UniqueName="CodigoN1">
            <HeaderStyle HorizontalAlign="Center" Font-Names="Arial" Font-Size="8pt" 
                Width="6%" />
            <ItemStyle Font-Names="Arial" Font-Size="8pt" />
        </telerik:GridBoundColumn>
...
<HeaderContextMenu CssClass="GridContextMenu GridContextMenu_Default"></HeaderContextMenu>
    ...
    <asp:SqlDataSource ID="Nivel1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:cnx %>" 
        SelectCommand="GetBalanceComprobacionN1" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:QueryStringParameter Name="Fecha" QueryStringField="Fecha" 
                Type="DateTime" />
            <asp:QueryStringParameter DefaultValue="" Name="idProyecto" 
                QueryStringField="Proyecto" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="Nivel2" runat="server" 
        ConnectionString="<%$ ConnectionStrings:cnx %>" 
        SelectCommand="GetBalanceComprobacionN2" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:QueryStringParameter Name="Fecha" QueryStringField="Fecha" 
                Type="DateTime" />
            <asp:QueryStringParameter DefaultValue="" Name="idProyecto" 
                QueryStringField="Proyecto" Type="Int32" />
            <asp:ControlParameter ControlID="RadGrid1" Name="CodigoN1" 
                PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="Nivel3" runat="server" 
        ConnectionString="<%$ ConnectionStrings:cnx %>" 
        SelectCommand="GetBalanceComprobacionN3" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:QueryStringParameter Name="Fecha" QueryStringField="Fecha" 
                Type="DateTime" />
            <asp:QueryStringParameter DefaultValue="" Name="idProyecto" 
                QueryStringField="Proyecto" Type="Int32" />
            <asp:ControlParameter ControlID="RadGrid1" Name="CodigoN2" 
                PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
