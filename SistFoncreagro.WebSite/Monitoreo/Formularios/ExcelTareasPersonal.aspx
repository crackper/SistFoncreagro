<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ExcelTareasPersonal.aspx.vb" Inherits="SistFoncreagro.WebSite.ExcelTareasPersonal" %>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Intervencion" HeaderText="Intervencion" ReadOnly="True" 
                ...
                <asp:BoundField DataField="personal" 
                    HeaderText="Personal Responsable" ReadOnly="True" SortExpression="Personal">
                <HeaderStyle BackColor="#000099" ForeColor="White" />
                </asp:BoundField>
                <asp:BoundField DataField="tipo" 
                    HeaderText="Tipo" ReadOnly="True" SortExpression="Tipo">
                <HeaderStyle BackColor="#000099" ForeColor="White" />
                </asp:BoundField>
            </Columns>
        </asp:GridView>
        <asp:SqlDataSource ID="SqlDatos" runat="server" 
            ...
            SelectCommand="RepCompromisosCaserios1" 
