<%@ Page Title="Emisión de Comprobantes" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contabilidad/MasterPageContabilidad.master" CodeBehind="ParamRepVentas.aspx.vb" Inherits="SistFoncreagro.WebSite.ParamRepVentas" %>
                ...
                <table class="fondoTabla" style="background-color: #0C3B2A; color: #FFFFFF;">
                    <tr class="Titulos">
                        <td class="Titulos" style="font-family: Arial; font-size: 10pt">
                            &nbsp;PARÁMETROS PARA MOSTRAR el reporte de emision de comprobantes</td>
                        <td>
                            &nbsp;</td>
