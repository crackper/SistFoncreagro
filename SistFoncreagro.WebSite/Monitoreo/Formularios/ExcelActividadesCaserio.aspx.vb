...
Public Class ExcelActividadesCaserio
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.SqlData.SelectParameters("IdProyecto").DefaultValue = Session("IdProyecto")

        Me.GridView1.DataSourceID = "SqlData"
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=ReporteActividadesCaserio.xls")
    ...
    Public Sub ExportToExcel(ByVal dataSrc As SqlDataSource, ByVal fileName As String)
        ...
        Me.SqlData.SelectParameters("IdProyecto").DefaultValue = Session("IsProyecto")
