<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Dialog2.aspx.vb" Inherits="SistFoncreagro.WebSite.Dialog2" %>
...
<body onload="AdjustRadWidow();">
    ...
    <script type="text/javascript">
        ...
        function returnToParent() {
            ...
            oArg.idOC = '<%= Request.QueryString("IdVenta") %>';
    ...
    <table class="style1">
        <tr>
            <td style="text-align: center">
                Ingrese la razón por la que se devuelve la Venta</td>
        </tr>
        <tr>
            <td style="text-align: center">
