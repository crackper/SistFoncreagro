<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VentanaAdjuntarArchivo.aspx.vb" Inherits="SistFoncreagro.WebSite.VentanaAdjuntarArchivo" %>
...
<body style="width: 610px;">
    ...
    <div>
        ...
        <table width="100%" style="font-family: Arial; font-size: 9pt">
            <tr>
                <td width="100" colspan="2" style="width: 530px">
                    <asp:Label ID="lblAdjuntar" runat="server"></asp:Label>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
