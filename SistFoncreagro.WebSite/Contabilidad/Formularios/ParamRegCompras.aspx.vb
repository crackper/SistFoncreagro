    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        If Me.RadComboBox3.SelectedValue.Length > 0 And Me.RadComboBox8.SelectedValue.Length > 0 Then
            ...
            cadena_java = "<script type='text/javascript'> " & _
                                         " window.open('RegCompras.aspx?fechaIni=" + Me.RadDatePicker1.SelectedDate.ToString + "&fechaFin=" + Me.RadDatePicker2.SelectedDate.ToString + "&moneda=" + Me.RadioButtonList1.SelectedValue + "&idProyecto=" + Me.RadComboBox3.SelectedValue.ToString + "&idProveedorCliente=" + Me.RadComboBox8.SelectedValue.ToString + "' ); " & _
                                         Chr(60) & "/script>"
            ScriptManager.RegisterStartupScript(Page, GetType(Page), "Cerrar", cadena_java.ToString, False)
        ElseIf Me.RadComboBox3.SelectedValue.Length > 0 And Me.RadComboBox8.SelectedValue.Length = 0 Then
            Dim cadena_java As String
            cadena_java = "<script type='text/javascript'> " & _
                                         " window.open('RegCompras.aspx?fechaIni=" + Me.RadDatePicker1.SelectedDate.ToString + "&fechaFin=" + Me.RadDatePicker2.SelectedDate.ToString + "&moneda=" + Me.RadioButtonList1.SelectedValue + "&idProyecto=" + Me.RadComboBox3.SelectedValue.ToString + "&idProveedorCliente=0' ); " & _
                                         Chr(60) & "/script>"
            ScriptManager.RegisterStartupScript(Page, GetType(Page), "Cerrar", cadena_java.ToString, False)
        ElseIf Me.RadComboBox3.SelectedValue.Length = 0 And Me.RadComboBox8.SelectedValue.Length > 0 Then
            Dim cadena_java As String
            cadena_java = "<script type='text/javascript'> " & _
                                         " window.open('RegCompras.aspx?fechaIni=" + Me.RadDatePicker1.SelectedDate.ToString + "&fechaFin=" + Me.RadDatePicker2.SelectedDate.ToString + "&moneda=" + Me.RadioButtonList1.SelectedValue + "&idProyecto=0&idProveedorCliente=" + Me.RadComboBox8.SelectedValue.ToString + "' ); " & _
                                         Chr(60) & "/script>"
            ScriptManager.RegisterStartupScript(Page, GetType(Page), "Cerrar", cadena_java.ToString, False)
        ElseIf Me.RadComboBox3.SelectedValue.Length = 0 And Me.RadComboBox8.SelectedValue.Length = 0 Then
            Dim cadena_java As String
            cadena_java = "<script type='text/javascript'> " & _
                                         " window.open('RegCompras.aspx?fechaIni=" + Me.RadDatePicker1.SelectedDate.ToString + "&fechaFin=" + Me.RadDatePicker2.SelectedDate.ToString + "&moneda=" + Me.RadioButtonList1.SelectedValue + "&idProyecto=0&idProveedorCliente=0' ); " & _
                                         Chr(60) & "/script>"
            ScriptManager.RegisterStartupScript(Page, GetType(Page), "Cerrar", cadena_java.ToString, False)
        End If
