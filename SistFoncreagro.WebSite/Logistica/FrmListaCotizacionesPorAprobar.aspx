<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmListaCotizacionesPorAprobar.aspx.vb" Inherits="SistFoncreagro.WebSite.FrmListaCotizacionesPorAprobar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="width: 931px; margin-left: 0px">
        <fieldset>
          <legend style="font-family: Arial; font-size: 12px; width: 80px;">Soul Source</legend>
    ...
    <Columns>
       <telerik:GridTemplateColumn UniqueName="TemplateColumn1" AllowFiltering="False" 
         ...
         <ItemTemplate>
          ...
          PostBackUrl='<%# "FrmCotizacionEditarAprobar.aspx?IdCoti=" & Eval("IdCotizacion")&"&IdReq="&Eval("IdRequerimiento") %>'
...
<HeaderContextMenu CssClass="GridContextMenu GridContextMenu_Default"></HeaderContextMenu>
    ...
    <asp:ObjectDataSource ID="odsCotizacionPendiente" runat="server" 
                    SelectMethod="GetAllFromCotizacionesByIdResponsable" 
