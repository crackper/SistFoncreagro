<%@ Page Title="Bienes de Baja" Language="vb" AutoEventWireup="false" MasterPageFile="~/Patrimonio/MasterPagePatrimonio.master" CodeBehind="ParamRepBajaBienes.aspx.vb" Inherits="SistFoncreagro.WebSite.ParamRepBajaBienes" %>
                ...
                <table class="fondoTabla" style="background-color: #0C3B2A; color: #FFFFFF;">
                    <tr class="Titulos">
                        <td class="Titulos" style="font-family: Arial; font-size: 10pt">
                            &nbsp;PARÁMETROS PARA MOSTRAR EL Reporte de bienes de baja</td>
                        <td>
                            &nbsp;</td>
                    ...
                    <tr class="Texto">
                        ...
                        <td style="text-align: left">
                            <asp:DropDownList ID="DropDownList1" runat="server">
                                ...
                                <asp:ListItem Value="C">No Activos</asp:ListItem>
