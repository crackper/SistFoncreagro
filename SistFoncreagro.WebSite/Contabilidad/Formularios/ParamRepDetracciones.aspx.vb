Public Class ParamRepDetracciones
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        cadena_java = "<script type='text/javascript'> " & _
                                     " window.open('ReporteDetracciones.aspx?fechaInicio=" + Me.RadDatePicker1.SelectedDate.ToString + "&fechaFin=" + Me.RadDatePicker2.SelectedDate.ToString + "&Idmoneda=" + Me.RadioButtonList1.SelectedValue + "&idProyecto=" + idProyecto.ToString + "&idProveedor=" + idProveedor.ToString + "' ); " & _
                                     Chr(60) & "/script>"
