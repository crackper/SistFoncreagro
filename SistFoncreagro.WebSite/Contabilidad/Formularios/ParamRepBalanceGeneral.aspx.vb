Public Class ParamRepBalanceGeneral
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        cadena_java = "<script type='text/javascript'> " & _
                                     " window.open('ReporteBalanceGeneral.aspx?FechaFin=" + Me.RadDatePicker1.SelectedDate.ToString + "&idProyecto=" + IdProyecto.ToString + "&tipo=" + Me.RadComboBox4.SelectedValue.ToString + "&proyecto=" + Me.RadComboBox3.Text.ToString + "' ); " & _
                                     Chr(60) & "/script>"
