<%@ Page Title="Registro de Ventas" Language="vb" AutoEventWireup="false"  CodeBehind="RegVentas.aspx.vb" Inherits="SistFoncreagro.WebSite.RegVentas" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table align="center" class="tabla4">
            <tr>
                <td>
                    <telerik:ReportViewer ID="ReportViewer1" runat="server" Height="780px" 
