<%@ Page Title="Registro de Compras" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contabilidad/MasterPageContabilidad.master" CodeBehind="ParamRegCompras.aspx.vb" Inherits="SistFoncreagro.WebSite.ParamRegCompras" %>
                ...
                <table class="fondoTabla" style="background-color: #0C3B2A; color: #FFFFFF;">
                    <tr class="Titulos">
                        <td class="Titulos" style="font-family: Arial; font-size: 10pt">
                            &nbsp;PARÁMETROS PARA MOSTRAR EL REGISTRO DE COMPRAS</td>
                        <td>
                            &nbsp;</td>
