...
Public Class FrmCajaEgresos
    ...
    Dim CtaBancariaProy As CtaBancariaProyecto
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            If Session("IdTransaccion") > 0 Then
                ...
                If Transaccion.IdSubDiario = 58 Or Transaccion.IdSubDiario = 5 Then
                ...
                Me.TextBox4.Text = Transaccion.NroCheque
                Me.TextBox2.Text = Transaccion.Enlace
                Me.HiddenField1.Value = Transaccion.IdMoneda
                Me.RadComboBox12.SelectedValue = Transaccion.IdTipoMedioPago
            Else
                Me.DropDownList1.SelectedValue = 1
                Me.RadComboBox12.SelectedValue = 3
    ...
    Protected Sub ImageButton9_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton9.Click
        If (Me.RadComboBox10.SelectedValue = 5 Or Me.RadComboBox10.SelectedValue = 58) Then
        ...
        Else
            ...
            CtaBancariaProy = CtaBancariaProyecto.GetSaldosCuentasBancarias(Me.RadComboBox9.SelectedValue, Me.RadComboBox3.SelectedValue, Session("Fecha"))
            If CtaBancariaProy Is Nothing Then
                SaldoProyecto = 0
            Else
    ...
    Protected Sub RadGrid1_DataBound(ByVal sender As Object, ByVal e As EventArgs) Handles RadGrid1.DataBound
        ...
        Else
            ...
            If Session("IdTransaccion") > 0 Then
                If RadComboBox10.SelectedValue = 58 Or RadComboBox10.SelectedValue = 5 Then
    ...
    Protected Sub RadGrid2_DataBound(ByVal sender As Object, ByVal e As EventArgs) Handles RadGrid2.DataBound
        ...
        For i = 0 To Me.RadGrid2.Items.Count - 1
            ...
            CType(Me.RadGrid2.Items(i).FindControl("odsCuentaEnlace"), ObjectDataSource).SelectParameters("Tipo").DefaultValue = "E"
            CType(Me.RadGrid2.Items(i).FindControl("RadComboBox1"), RadComboBox).DataBind()
            If Me.RadGrid2.Items(i)("Cuenta").Text = "401103" Then
                texto = "DETRACCION FACTURA "
            ElseIf Me.RadGrid2.Items(i)("IdTipoDocumento").Text = 2 Then
                texto = "CANCELACION FACTURA "
            ElseIf Me.RadGrid2.Items(i)("IdTipoDocumento").Text = 3 Then
                texto = "CANCELACION HONORARIOS "
            ElseIf Me.RadGrid2.Items(i)("IdTipoDocumento").Text = 4 Then
                texto = "CANCELACION BOLETA "
            ElseIf Me.RadGrid2.Items(i)("IdTipoDocumento").Text = 8 Then
                texto = "CANCELACION N/C "
            ElseIf Me.RadGrid2.Items(i)("IdTipoDocumento").Text = 13 Then
                texto = "CANCELACION TICKET "
            ElseIf Me.RadGrid2.Items(i)("IdTipoDocumento").Text = 15 Then
                texto = "CANCELACION RECIBO "
            ElseIf Me.RadGrid2.Items(i)("IdTipoDocumento").Text = 16 Then
                texto = "CANCELACION BOLETO "
            ElseIf Me.RadGrid2.Items(i)("IdTipoDocumento").Text = 17 Then
                texto = "CANCELACION BOLETO "
            ElseIf Me.RadGrid2.Items(i)("Cuenta").Text = "102001" Then
                texto = "REPOSICIÓN DE FONDO FIJO "
            End If
    ...
    Protected Sub RadAjaxManager1_AjaxRequest(ByVal sender As Object, ByVal e As Telerik.Web.UI.AjaxRequestEventArgs) Handles RadAjaxManager1.AjaxRequest
        ...
        ElseIf e.Argument = "ActualizarGrilla" Then
            Me.RadGrid2.DataBind()
        ElseIf e.Argument = "CopiarCoa" Then
            Me.RadComboBox11.SelectedValue = Me.RadComboBox8.SelectedValue
        End If
    ...
    Protected Sub ImageButton13_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton13.Click
        ...
        Else
            If Me.RadComboBox10.SelectedValue = 57 Or Me.RadComboBox10.SelectedValue = 58 Then
                    ...
                    If Me.RadGrid1.Items(i)("Enlace").Text = "S" Then
                        ...
                        If Me.RadGrid1.Items(i)("Flag").Text = "E" Then
                            ...
                            If (Me.RadComboBox10.SelectedValue = 1 Or Me.RadComboBox10.SelectedValue = 54) Then
                                ...
                                For t = 1 To Len(TextBox4.Text)
                                    If Asc(Mid(UCase(TextBox4.Text), t, 1)) >= 48 And Asc(Mid(UCase(TextBox4.Text), t, 1)) <= 57 Then
                                        cheque = cheque & Mid(TextBox4.Text, t, 1)
                                    End If
                                Next
                                _Linea2.NroDocumento = Int64.Parse(cheque)
