<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteBalanceComprobacionAcumuladoMayor.aspx.vb" Inherits="SistFoncreagro.WebSite.ReporteBalanceComprobacionAcumuladoMayor" %>
...
<head id="Head1" runat="server">
    <title>Reporte de Balance de Comprobación Acumulado</title>
...
<body>
    ...
    <div style="background-color: #FFFFFF" >
        <table align="center" class="tabla4">
            <tr>
                <td>
                    <telerik:ReportViewer ID="ReportViewer1" runat="server" Height="750px" 
