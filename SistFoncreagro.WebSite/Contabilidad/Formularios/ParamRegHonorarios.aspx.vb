Public Class ParamRegHonorarios
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        cadena_java = "<script type='text/javascript'> " & _
                                     " window.open('RegHonorarios.aspx?fechaIni=" + Me.RadDatePicker1.SelectedDate.ToString + "&fechaFin=" + Me.RadDatePicker2.SelectedDate.ToString + "&moneda=" + Me.RadioButtonList1.SelectedValue + "&idProyecto=" + idProyecto.ToString + "&idProveedorCliente=" + idProveedorCliente.ToString + "' ); " & _
                                     Chr(60) & "/script>"
