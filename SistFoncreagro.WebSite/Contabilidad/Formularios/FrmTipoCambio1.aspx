<%@ Page Title="Tipo de Cambio" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmTipoCambio1.aspx.vb" Inherits="SistFoncreagro.WebSite.FrmTipoCambio1" %>
        ...
        <tr>
            <td>
                                            ...
                                            <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/img/Grabar.gif" 
                                                ToolTip="Grabar" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Image ID="Image1" runat="server" ImageUrl="~/img/alerta.gif" 
                                                ToolTip="Actualice el Tipo de Cambio hasta la Fecha de Proceso" />
                                    ...
                                    <table align="center" class="tabla4">
                                        ...
                                        <tr class="Texto">
                                            ...
                                            <td style="font-family: Arial; font-size: 9pt">
                                                ...
                                                Font-Names="Arial" Font-Size="9pt" Width="250px" Enabled="False">
                                                </asp:ComboBox>
