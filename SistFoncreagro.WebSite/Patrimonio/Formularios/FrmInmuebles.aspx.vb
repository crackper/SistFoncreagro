...
Public Class FrmInmuebles
        ...
        If Page.IsPostBack = False Then
            ...
            If IdBienInmueble > 0 Then
                ...
                If bienInmueble.IdProveedorCliente > 0 Then
                    _Proveedor = Proveedor.GetAllFromProveedorClienteById(bienInmueble.IdProveedorCliente)
    ...
    Protected Sub ImageButton4_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton4.Click
        Response.Redirect("FrmInmuebles.aspx?IdBienInmueble=0")
    End Sub
    ...
    Protected Sub ImageButton3_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton3.Click
        ...
        If IdBienInmueble > 0 Then
            bienInmuebleBL.SaveBIENINMUEBLE(_BienInmueble)
        Else
            IdBienInmueble = bienInmuebleBL.SaveBIENINMUEBLE(_BienInmueble)
        End If

        Response.Redirect("FrmInmuebles.aspx?IdBienInmueble=" + IdBienInmueble.ToString)
    End Sub
End Class