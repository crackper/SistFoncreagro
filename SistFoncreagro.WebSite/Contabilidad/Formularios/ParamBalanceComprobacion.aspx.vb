...
Public Class ParamBalanceComprobacion
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        Response.Redirect("BalanceComprobacion.aspx?Fecha=" + (Me.RadDatePicker1.SelectedDate.ToString).Substring(0, 10) + "&Proyecto=" + IdProyecto.ToString)
    End Sub
End Class