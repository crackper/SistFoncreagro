<%@ Page Title="Movimientos Transitorios - Egresos" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contabilidad/MasterContabilidad1.master" CodeBehind="FrmTransitorioEgresos.aspx.vb" Inherits="SistFoncreagro.WebSite.FrmTransitorioEgresos" %>
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" class="tabla4" __designer:mapid="efa">
                                                                                    ...
                                                                                    <tr class="Texto" __designer:mapid="f06">
                                                                                        <td colspan="4" style="font-size: 9pt" __designer:mapid="f07">
                                                                                            ...
                                                                                            <asp:TextBox ID="TextBox5" runat="server" TextMode="MultiLine" Width="97%" 
                                                                                                TabIndex="9" CssClass="TextBoxAlignIzquierda" Rows="2"></asp:TextBox>
                                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                                                                                                ...
                                                                                                ControlToValidate="TextBox5"></asp:RequiredFieldValidator>
                                                                                                    ...
                                                                                                    <td style="text-align: left" width="6%">
                                                                                                        Enlace:</td>
                                                                                                    <td width="43%" colspan="2" style="width: 16%">
                                                                                            ...
                                                                                            <asp:TextBox ID="TextBox2" runat="server" Width="99%" Rows="2" 
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="Texto" colspan="5" style="font-weight: 700">
                                                                                            Buscar Cuentas Pendientes</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td width="8%" colspan="2" style="width: 80%">
                                                                                            <telerik:RadComboBox ID="RadComboBox11" Runat="server" AllowCustomText="True" DataTextField="NombreProveedor" 
                                                                                                ...
                                                                                                ShowMoreResultsBox="True" ValidationGroup="Transaccion" Width="100%" EnableAjaxSkinRendering="False" 
                                                                                                    ...
                                                                                                    <td style="text-align: left; width: 12%;" width="4%" colspan="2">
                                                                                ...
                                                                                <MasterTableView ClientDataKeyNames="IdLinea" DataKeyNames="IdLinea" 
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <telerik:GridBoundColumn DataField="Enlace" 
                                                                                            FilterControlAltText="Filter Enlace column" HeaderText="Enlace" 
                                                                                            UniqueName="Enlace">
                                                                                        </telerik:GridBoundColumn>
                                                                                    </Columns>
...
<telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function Cargar() {
            $find("<%= RadAjaxManager1.ClientID %>").ajaxRequest("Cargar");
        }
     </script>
