<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Monitoreo/MasterMonitoreo1.master" CodeBehind="DetalleReq.aspx.vb" Inherits="SistFoncreagro.WebSite.DetalleReq" %>
    ...
    <table id="tablaRequerimiento" cellpadding="0" cellspacing="0">
              ...
              <tr>
                  ...
                  <td style="width: 70%;" class="tablaJcv">
                        <telerik:RadComboBox ID="rcbCentroCosto" Runat="server" AllowCustomText="True" 
                            ...
                            ShowMoreResultsBox="True" Width="447px" Enabled="False">
                        </telerik:RadComboBox>
                    </td>
              </tr>
              <tr>
                  ...
                  <td style="width: 70%;" class="tablaJcv">
                        <asp:TextBox ID="txtSustento" runat="server" Width="442px" 
                            ValidationGroup="Validar" CssClass="CajaTexto" ReadOnly="True"></asp:TextBox>
     ...
     <fieldset class="jcv">
        ...
        <table class="tablaJcv">
                                ...
                                <asp:TemplateField HeaderText="Unidad" SortExpression="IdUnidadMedida">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="ddlUnidadMedida" runat="server" 
                                            ...
                                            SelectedValue='<%# Bind("IdUnidadMedida") %>' Width="80px" Enabled="False">
                                        </asp:DropDownList>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Cantidad" SortExpression="Cantidad">
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtCantidad" runat="server" BackColor="Info" 
                                            CssClass="TextoCentro" Text='<%# Bind("Cantidad") %>' Width="50px" 
          ...
          <tr>
              <td colspan="3">
                 <asp:Panel ID="PanelBusquedaItems" runat="server" Width="900px">
                    <table class="tabla4" style="width: 900px">
                        <tr>
                            ...
                            <td style="height: 25px; width: 20px;">
