<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteMovSemovientes.aspx.vb" Inherits="SistFoncreagro.WebSite.ReporteMovSemovientes" %>
...
<head id="Head1" runat="server">
    <title>Nacimientos, Ventas y Muertes de Activos Biológicos</title>
    ...
    <div style="background-color: #FFFFFF" >
        <table align="center" class="tabla5">
            ...
            ParametersAreaVisible="False" ProgressText="Generando Vista Preliminar..." 
               Width="1050px" BorderStyle="None" BorderWidth="1px" ShowHistoryButtons="False" 
