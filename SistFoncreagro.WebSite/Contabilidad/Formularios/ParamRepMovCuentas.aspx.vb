Public Class ParamRepMovCuentas
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        cadena_java = "<script type='text/javascript'> " & _
                                     " window.open('ReporteMovCuentas.aspx?Fecha=" + Me.RadDatePicker1.SelectedDate.ToString + "&idProyecto=" + idProyecto.ToString + "&CuentaInicio=" + CuentaInicio.ToString + "&CuentaFin=" + CuentaFin.ToString + "' ); " & _
                                     Chr(60) & "/script>"
