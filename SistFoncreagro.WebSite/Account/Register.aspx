<%@ Page Title="Registrarse" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false"
    CodeBehind="Register.aspx.vb" Inherits="SistFoncreagro.WebSite.Register" %>

<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
</asp:Content>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:CreateUserWizard ID="RegisterUser" runat="server" 
        ContinueDestinationPageUrl="~/Account/FrmListaUsuarios.aspx">
        <LayoutTemplate>
                ...
                <ContentTemplate>
                    ...
                    <div class="accountInfo">
                        <fieldset class="register">
                           ...
                           <p>
                                <asp:Label ID="Label1" runat="server" AssociatedControlID="UserName">Personal:</asp:Label>
                                <asp:DropDownList ID="ddlPersonal" runat="server" 
                                    DataSourceID="odsPersonalNotUser" DataTextField="NombrePersonalCompleto" 
                                    DataValueField="IdUsuario" Width="320px">
                                </asp:DropDownList>
                                <asp:ObjectDataSource ID="odsPersonalNotUser" runat="server" 
                                    SelectMethod="GetAllFromPersonalSinUsuarioGetAllFromPersonalNotUser" 
