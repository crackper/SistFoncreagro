...
Public Interface IJornadaLaboralBL
    ...
    Function SaveCrearJornadaLaboralPorPersonayControlAsistencia(ByVal IdPeriodoLaboral As Int32, ByVal IdPeriodoDeclaracion As Int32) As Int32
