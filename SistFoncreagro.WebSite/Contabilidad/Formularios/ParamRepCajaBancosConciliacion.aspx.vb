Public Class ParamRepCajaBancosConciliacion
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        cadena_java = "<script type='text/javascript'> " & _
                                         " window.open('ReporteCajaBancosConciliacion.aspx?Fecha=" + Me.RadDatePicker1.SelectedDate.ToString + "&idProyecto=" + idProyecto.ToString + "&CuentaInicio=" + CuentaInicio.ToString + "&CuentaFin=" + CuentaFin.ToString + "' ); " & _
                                         Chr(60) & "/script>"
    ...
    Protected Sub RadComboBox1_SelectedIndexChanged(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles RadComboBox1.SelectedIndexChanged
        Me.RadComboBox4.Text = ""
        Me.RadComboBox4.SelectedValue = Me.RadComboBox1.SelectedValue
        Me.RadComboBox4.Text = Me.RadComboBox1.Text
    End Sub
