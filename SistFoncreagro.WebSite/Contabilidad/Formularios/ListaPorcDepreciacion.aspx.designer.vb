...
Partial Public Class ListaPorcDepreciacion
    ...
    '''<summary>
    '''Control OdsPorcentajes.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents OdsPorcentajes As Global.System.Web.UI.WebControls.ObjectDataSource
