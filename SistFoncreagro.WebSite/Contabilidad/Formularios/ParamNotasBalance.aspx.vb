Public Class ParamNotasBalance
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
       ...
       Dim cadena_java As String
        ...
        cadena_java = "<script type='text/javascript'> " & _
                                     " window.open('ReporteNotasBalance.aspx?FechaFin=" + Me.RadDatePicker1.SelectedDate.ToString + "&IdProyecto=" + IdProyecto.ToString + "&tipo=" + Me.RadComboBox4.SelectedValue.ToString + "&proyecto=" + Me.RadComboBox3.Text.ToString + "' ); " & _
                                     Chr(60) & "/script>"
