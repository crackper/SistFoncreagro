...
Public Class ExcelTareasPersonal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=ReporteTareasCaserios.xls")
    ...
    Protected Sub GridView1_DataBound(sender As Object, e As EventArgs) Handles GridView1.DataBound
        For i = 0 To Me.GridView1.Rows.Count - 1
            If (Me.GridView1.Rows(i).Cells(8).Text = "PROGRAMADO") Then
                Me.GridView1.Rows(i).Cells(8).BackColor = Drawing.Color.Yellow
            ElseIf (Me.GridView1.Rows(i).Cells(8).Text = "EJECUTADO") Then
                Me.GridView1.Rows(i).Cells(8).BackColor = Drawing.Color.Blue
            ElseIf (Me.GridView1.Rows(i).Cells(8).Text = "REPROGRAMADO") Then
                Me.GridView1.Rows(i).Cells(8).BackColor = Drawing.Color.Silver
            End If
        Next
    End Sub
End Class