<%@ Page Title="Libro de Inventarios y Balances - Detalle del saldo de la Cuenta 46 - Cuentas por pagar Diversas" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contabilidad/MasterPageContabilidad.master" CodeBehind="ParamRepSaldoCuenta46.aspx.vb" Inherits="SistFoncreagro.WebSite.ParamRepSaldoCuenta46" %>
                ...
                <table class="fondoTabla" style="background-color: #0C3B2A; color: #FFFFFF;">
                    <tr class="Titulos">
                        <td class="Titulos" style="font-family: Arial; font-size: 10pt">
                            &nbsp;PARÁMETROS PARA MOSTRAR el saldo de la cuenta 46 - cuentas por pagar diversas</td>
                        <td>
                            &nbsp;</td>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" ToolTip="Abrir Calendario."></DatePopupButton>
                ...
                ToolTip="Mostrar" AccessKey="s" style="width: 28px; height: 25px;" />
