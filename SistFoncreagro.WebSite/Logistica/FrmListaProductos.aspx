<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmListaProductos.aspx.vb" Inherits="SistFoncreagro.WebSite.FrmListaProductos" %>
...
<script type="text/javascript">
    function CargarVentanaCatalogo(id, tipo) {
        var oWnd = radopen("VentanaCatalogo.aspx?id=" + id + "&tip=" + tipo, "EditarCatalogo");
    }

    function NuevoProducto() {
        var oWnd = radopen("VentanaCatalogo.aspx", "NuevoProducto");
        return false;
    }
    ...
    <div style="width: 931px; margin-left: 0px">
        <fieldset>
                <legend style="font-family: Arial; font-size: 15px; width: 178px;">Catálogo de 
                    Productos</legend>
...
<CommandItemSettings ExportToPdfText="Exportar a PDF" 
        AddNewRecordText="Nuevo Producto"  RefreshText="Refrescar" ></CommandItemSettings>
...
<HeaderContextMenu CssClass="GridContextMenu GridContextMenu_Default"></HeaderContextMenu>
    ...
    <telerik:RadWindowManager ID="RadWindowManager2" runat="server">
       <Windows>
              <telerik:RadWindow ID="NuevoProducto" runat="server" Title="NUEVO PRODUCTO" Height="450px"
                        Width="795px" Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false"
                        Modal="true" Animation="Resize" />
              <telerik:RadWindow ID="EditarCatalogo" runat="server" Title="EDITAR PRODUCTO" Height="450px"
                        Width="795px" Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false"
                        Modal="true" Animation="Resize" />                         
              </Windows>
