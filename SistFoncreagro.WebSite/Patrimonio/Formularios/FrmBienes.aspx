<%@ Page Title="Registro de Bienes Muebles" Language="vb" AutoEventWireup="false" MasterPageFile="~/Patrimonio/MasterPatrimonio1.master" CodeBehind="FrmBienes.aspx.vb" Inherits="SistFoncreagro.WebSite.FrmBienes" %>
                                                                                                    ...
                                                                                                    <table style="width: 100%">
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td style="text-align: left" width="10%">
                                                                                                                <asp:TextBox ID="TextBox1" runat="server" Enabled="False" TabIndex="27" 
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td width="88%">
                                                                                                                            <telerik:RadComboBox ID="RadComboBox1" Runat="server" AutoPostBack="True" 
                                                                                                                                ...
                                                                                                                                TabIndex="1" ValidationGroup="Transaccion" Width="100%">
                                                                                                                            </telerik:RadComboBox>
                                                                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                                                                                                                                ControlToValidate="RadComboBox1" Display="Dynamic" 
                                                                                                                                ErrorMessage="¡Debe ingresar el Catálogo!"></asp:RequiredFieldValidator>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td width="12%">
                                                                                                                ...
                                                                                                                <table style="width: 100%">
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <asp:DropDownList ID="DropDownList1" runat="server" Font-Names="Arial" 
                                                                                                                                Font-Size="8pt" TabIndex="4" Width="140px">
                                                                                                                                <asp:ListItem Selected="True">OPERATIVO</asp:ListItem>
                                                                                                                                <asp:ListItem>INOPERATIVO</asp:ListItem>
                                                                                                                            </asp:DropDownList>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            <asp:CheckBox ID="CheckBox1" runat="server" TabIndex="5" Text="Donación" />
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            &nbsp;</td>
                                                                                                                        <td>
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td width="12%">
                                                                                                                            Cod. Referencia:</td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="TextBox11" runat="server" CssClass="Texto1" TabIndex="6" 
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td width="12%">
                                                                                                                            Bien Padre:</td>
                                                                                                                        <td colspan="8">
                                                                                                                            <telerik:RadComboBox ID="RadComboBox9" Runat="server" DataTextField="Bien" 
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td width="12%">
                                                                                                                            Descripción:</td>
                                                                                                                        <td colspan="8">
                                                                                                                            <asp:TextBox ID="TextBox10" runat="server" CssClass="Texto1" Rows="1" 
                                                                                                                                TabIndex="8" Width="99%"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                </table>
                                                                                                            </td>
                                                                                                                ...
                                                                                                                <table style="width: 100%">
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td style="text-align: right" width="6%">
                                                                                                                            Serie:</td>
                                                                                                                        <td width="10%">
                                                                                                                            <asp:TextBox ID="TextBox3" runat="server" CssClass="Texto1" MaxLength="4" 
                                                                                                                                TabIndex="10" Width="70px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td style="text-align: right" width="5%">
                                                                                                                            N°:</td>
                                                                                                                        <td width="10%">
                                                                                                                            <asp:TextBox ID="TextBox2" runat="server" CssClass="Texto1" TabIndex="11" 
                                                                                                                                Width="80px"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td style="text-align: right" width="12%">
                                                                                                                            Fecha Compra:</td>
                                                                                                                        <td width="10%">
                                                                                                                            <asp:TextBox ID="txtDate" runat="server" AutoPostBack="True" TabIndex="12" 
                                                                                                                                Width="70px" />
                                                                                                                        ...
                                                                                                                        <td width="10%">
                                                                                                                            <telerik:RadNumericTextBox ID="RadNumericTextBox3" Runat="server" 
                                                                                                                                AutoPostBack="True" TabIndex="13" Value="0" Width="70px">
                                                                                                                ...
                                                                                                                <table style="width: 100%">
                                                                                                                    <tr>
                                                                                                                        <td width="12%">
                                                                                                                            Marca:</td>
                                                                                                                        <td width="20%">
                                                                                                                            <telerik:RadComboBox ID="RadComboBox10" Runat="server" AllowCustomText="True" 
                                                                                                                        ...
                                                                                                                        <td width="5%">
                                                                                                                            <asp:ImageButton ID="ImageButton8" runat="server" CausesValidation="False" 
                                                                                                                                ImageAlign="Middle" ImageUrl="~/img/Agregar.gif" ToolTip="Registrar Marca" />
                                                                                                                        </td>
                                                                                                                        <td width="7%">
                                                                                                                            Modelo:</td>
                                                                                                                        <td width="25%">
                                                                                                                            <asp:TextBox ID="TextBox4" runat="server" CssClass="Texto1" TabIndex="16" 
                                                                                                                                Width="96%"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td width="6%">
                                                                                                                            Serie:</td>
                                                                                                                        <td width="25%">
                                                                                                                            <asp:TextBox ID="TextBox5" runat="server" CssClass="Texto1" TabIndex="17" 
                                                                                                                                Width="96%"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td>
                                                                                                                            Placa:</td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="TextBox6" runat="server" CssClass="Texto1" TabIndex="18" 
                                                                                                                                Width="96%"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            &nbsp;</td>
                                                                                                                        <td>
                                                                                                                            Motor:</td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="TextBox7" runat="server" CssClass="Texto1" TabIndex="19" 
                                                                                                                                Width="96%"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                        <td>
                                                                                                                            Color:</td>
                                                                                                                        <td>
                                                                                                                            <asp:TextBox ID="TextBox8" runat="server" CssClass="Texto1" TabIndex="20" 
                                                                                                                                Width="96%"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td>
                                                                                                                            Otros:</td>
                                                                                                                        <td colspan="6">
                                                                                                                            <asp:TextBox ID="TextBox9" runat="server" CssClass="Texto1" Rows="1" 
                                                                                                                                TabIndex="21" Width="99%"></asp:TextBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                </table>
                                                                                                            </td>
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            ...
                                                                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" 
                                                                                                                                ...
                                                                                                                                ErrorMessage="¡Debe ingresar la Oficina!"></asp:RequiredFieldValidator>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                </table>
                                                                                                            </td>
                                                                                                                ...
                                                                                                                <table class="style6" width="100%">
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td width="88%" style="text-align: left">
                                                                                                                            <asp:RadioButtonList ID="RadioButtonList1" runat="server" CssClass="Texto1" 
                                                                                                                                RepeatDirection="Horizontal" TabIndex="23">
                                                                                                                                <asp:ListItem Selected="True" Value="A">Activo Fijo</asp:ListItem>
                                                                                                                                <asp:ListItem Value="C">Cuentas de Orden</asp:ListItem>
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <telerik:RadComboBox ID="RadComboBox7" Runat="server" DataTextField="Cuenta" 
                                                                                                                                DataValueField="Codigo" EnableLoadOnDemand="True" MarkFirstMatch="True" 
                                                                                                                                ShowDropDownOnTextboxClick="False" ShowMoreResultsBox="True" TabIndex="25" 
                                                                                                                                Width="100%" Skin="Hay">
                                                                                                                            </telerik:RadComboBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <telerik:RadComboBox ID="RadComboBox8" Runat="server" DataTextField="Cuenta" 
                                                                                                                                DataValueField="Codigo" EnableLoadOnDemand="True" MarkFirstMatch="True" 
                                                                                                                                ShowDropDownOnTextboxClick="False" ShowMoreResultsBox="True" TabIndex="26" 
                                                                                                                                Width="100%" Skin="Hay">
                                                                                                                            </telerik:RadComboBox>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" 
                                                                                                        ...
                                                                                                        <MasterTableView ClientDataKeyNames="IdResponsable" CommandItemDisplay="Top" 
                                                                                                            ...
                                                                                                            <CommandItemSettings AddNewRecordText="Agregar Responsable" 
                                                                                                            ...
                                                                                                            <Columns>
                                                                                                                ...
                                                                                                                <telerik:GridBoundColumn DataField="Personal" 
                                                                                                                    ...
                                                                                                                    ReadOnly="True" SortExpression="Personal" UniqueName="Personal">
                                                                                                                ...
                                                                                                                <telerik:GridBoundColumn DataField="FechaFin" DataFormatString="{0:dd/MM/yyyy}" 
                                                                                                                    ...
                                                                                                                    HeaderText="Fecha Fin" SortExpression="FechaFin" UniqueName="FechaFin">
                                                                                                                    <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                                                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                                                                </telerik:GridBoundColumn>
                                                                                                                ...
                                                                                                                <telerik:GridBoundColumn DataField="IdResponsable" DataType="System.Int32" 
                                                                                                            ...
                                                                                                            <EditFormSettings EditFormType="WebUserControl" 
                                                                                                                UserControlName="~\Patrimonio\Controles\ControlResponsable.ascx">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <telerik:RadGrid ID="RadGrid2" runat="server" Skin="Hay" 
                                                                                                        ...
                                                                                                        GridLines="None">
                                                                                                        <MasterTableView ClientDataKeyNames="IdEstado" CommandItemDisplay="Top" 
                                                                                                            ...
                                                                                                            <Columns>
                                                                                                                <telerik:GridEditCommandColumn ButtonType="ImageButton" EditText="Editar" 
                                                                                                                    FilterControlAltText="Filter EditCommandColumn column">
                                                                                                                    <HeaderStyle HorizontalAlign="Center" Width="1.5%" />
                                                                                                                </telerik:GridEditCommandColumn>
                                                                                                                <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" 
                                                                                                                    ConfirmDialogType="RadWindow" 
                                                                                                                ...
                                                                                                                <telerik:GridBoundColumn DataField="Observacion" 
                                                                                                                    FilterControlAltText="Filter Observacion column" HeaderText="Observación" 
                                                                                                                    SortExpression="Observacion" UniqueName="Observacion">
                                                                                                                    <HeaderStyle HorizontalAlign="Center" Width="67%" />
                                                                                                                </telerik:GridBoundColumn>
                                                                                                                <telerik:GridBoundColumn DataField="IdBienMueble" DataType="System.Int32" 
                                                                                                                    FilterControlAltText="Filter IdBienMueble column" HeaderText="IdBienMueble" 
                                                                                                                    SortExpression="IdBienMueble" UniqueName="IdBienMueble" Visible="False">
                                                                                                                ...
                                                                                                                <telerik:GridBoundColumn DataField="IdEstado" DataType="System.Int32" 
                                                                                                                    FilterControlAltText="Filter IdEstado column" HeaderText="IdEstado" 
                                                                                                                    ReadOnly="True" SortExpression="IdEstado" UniqueName="IdEstado" Visible="False">
                                                                                                                </telerik:GridBoundColumn>
                                                                                                                <telerik:GridBoundColumn DataField="IdTipo" DataType="System.Int32" 
                                                                                                                    FilterControlAltText="Filter IdTipo column" HeaderText="IdTipo" 
                                                                                                                    SortExpression="IdTipo" UniqueName="IdTipo" Visible="False">
                                                                                                                </telerik:GridBoundColumn>
                                                                                                            </Columns>
                                                                                                            <EditFormSettings EditFormType="WebUserControl" 
                                                                                                                UserControlName="~\Patrimonio\Controles\ControlEstado.ascx">
                                                                                                                <EditColumn FilterControlAltText="Filter EditCommandColumn column">
                                                                                                                </EditColumn>
                                                                                                            </EditFormSettings>
                                                                                                        </MasterTableView>
