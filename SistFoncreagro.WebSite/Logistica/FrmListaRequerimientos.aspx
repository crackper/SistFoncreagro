<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmListaRequerimientos.aspx.vb" Inherits="SistFoncreagro.WebSite.FrmListaRequerimientos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">               
    <div style="width: 931px; margin-left: 0px">
        <fieldset>
                <legend style="font-family: Arial; font-size: 12px; width: 182px;">Requerimientos de Compra</legend>
               <div style="height: 900px; overflow: scroll; width: 895px;" class="grid">
    ...
    <Columns>
       <telerik:GridTemplateColumn UniqueName="TemplateColumn1" AllowFiltering="False" 
         ...
         <ItemTemplate>
          ...
          PostBackUrl='<%# "FrmRequerimientoEditar.aspx?IdReq=" & Eval("IdRequerimiento") %>'
        ...
        <telerik:GridBoundColumn DataField="FechaRequerimiento" 
            ...
            FilterControlAltText="filtro3" 
            HeaderText="Fecha Req." SortExpression="FechaRequerimiento" 
            UniqueName="TemplateColumn3" DataFormatString="{0:dd/MM/yyyy}" 
...
<HeaderContextMenu CssClass="GridContextMenu GridContextMenu_Default"></HeaderContextMenu>
    ...
    <asp:ObjectDataSource ID="odsRequerimientos" runat="server" 
                    SelectMethod="GetAllFromRequerimientoByIdPersona" 
                    TypeName="SistFoncreagro.BussinesLogic.RequerimientoBL">
      <SelectParameters>
          <asp:SessionParameter Name="IdPersona" SessionField="IdUser" Type="Int32" />
      </SelectParameters>
