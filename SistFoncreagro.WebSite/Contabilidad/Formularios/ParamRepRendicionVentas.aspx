<%@ Page Title="Rendición de Ventas" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contabilidad/MasterPageContabilidad.master" CodeBehind="ParamRepRendicionVentas.aspx.vb" Inherits="SistFoncreagro.WebSite.ParamRepRendicionVentas" %>
                ...
                <table class="fondoTabla" style="background-color: #0C3B2A; color: #FFFFFF;">
                    <tr class="Titulos">
                        <td class="Titulos" style="font-family: Arial; font-size: 10pt">
                            &nbsp;PARÁMETROS PARA MOSTRAR la rendicion de ventas</td>
                        <td>
                            &nbsp;</td>
