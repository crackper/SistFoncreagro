Public Class ParamRepSaldoCuenta14
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        cadena_java = "<script type='text/javascript'> " & _
                                     " window.open('ReporteSaldoCuenta14.aspx?IdMoneda=" + Me.RadioButtonList1.SelectedValue + "&IdProveedor=" + IdProveedor.ToString + "&FechaFin=" + Me.RadDatePicker1.SelectedDate.ToString + "&IdProyecto=" + IdProyecto.ToString + "&Proyecto=" + Proyecto.ToString + "' ); " & _
                                     Chr(60) & "/script>"
