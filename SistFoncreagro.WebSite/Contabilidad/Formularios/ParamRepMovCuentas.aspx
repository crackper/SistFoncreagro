<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contabilidad/MasterPageContabilidad.master" CodeBehind="ParamRepMovCuentas.aspx.vb" Inherits="SistFoncreagro.WebSite.ParamRepMovCuentas" %>
                ...
                <table class="fondoTabla" style="background-color: #0C3B2A; color: #FFFFFF;">
                    <tr class="Titulos">
                        <td class="Titulos" style="font-family: Arial; font-size: 10pt">
                            &nbsp;Parametros para mostrar el reporte de movimientos de cuentas</td>
                        <td>
                            &nbsp;</td>
