<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ControlCuentaProyecto.ascx.vb" Inherits="SistFoncreagro.WebSite.ControlCuentaProyecto" %>
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" style="width: 100%">
                                                                                    <tr class="Texto">
                                                                                        ...
                                                                                        <td width="92%">
                                                                                            <telerik:RadComboBox ID="RadComboBox1" Runat="server" AllowCustomText="True" 
                                                                                                ...
                                                                                                ValidationGroup="Transaccion" Width="70%">
                                                                                            </telerik:RadComboBox>
                                                                                    ...
                                                                                    <tr class="Texto">
                                                                                        <td width="8%" style="text-align: left" >
                                                                                            Observación:</td>
                                                                                        <td width="92%">
                                                                                            <asp:TextBox ID="TextBox1" runat="server" TextMode="MultiLine" Width="70%"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
        </td>
