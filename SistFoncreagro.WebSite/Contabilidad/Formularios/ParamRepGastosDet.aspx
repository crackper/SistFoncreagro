<%@ Page Title="Consolidado de Gastos" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contabilidad/MasterPageContabilidad.master" CodeBehind="ParamRepGastosDet.aspx.vb" Inherits="SistFoncreagro.WebSite.ParamRepGastosDet" %>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" ToolTip="Abrir Calendario."></DatePopupButton>
                ...
                ToolTip="Mostrar" AccessKey="s" />
                                                ...
                                                <asp:ObjectDataSource ID="odsSubDiario" runat="server" 
                                                    SelectMethod="GetAllSUBDIARIOActivos" 
