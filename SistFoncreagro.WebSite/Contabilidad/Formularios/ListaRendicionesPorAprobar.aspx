<%@ Page Title="Lista de Rendiciones Para Aprobar" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contabilidad/MasterPageContabilidad.master" CodeBehind="ListaRendicionesPorAprobar.aspx.vb" Inherits="SistFoncreagro.WebSite.ListaRendicionesPorAprobar" %>
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        ...
        <telerik:GridTemplateColumn DataField="NomEstado" HeaderText="Estado" UniqueName="NomEstado"
            ...
            <ItemTemplate>
                <asp:Label ID="Label1" runat="server" Text='<%# Eval("NomEstado") %>' ></asp:Label>
            </ItemTemplate>
             <FilterTemplate>
...
<HeaderContextMenu CssClass="GridContextMenu GridContextMenu_Default"></HeaderContextMenu>
        ...
        <asp:ObjectDataSource ID="odsRendicion" runat="server" 
                                SelectMethod="GetRENDICIONByEstado" 
                                
    TypeName="SistFoncreagro.BussinesLogic.RendicionBL">
            <SelectParameters>
                <asp:Parameter DefaultValue="2" Name="Estado" Type="String" />
