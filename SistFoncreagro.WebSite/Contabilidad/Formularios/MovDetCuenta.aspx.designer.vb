...
Partial Public Class MovDetCuenta
    ...
    '''<summary>
    '''Control DetalleCuenta.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents DetalleCuenta As Global.System.Web.UI.WebControls.SqlDataSource
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents Movimiento As Global.Telerik.Web.UI.RadWindow
