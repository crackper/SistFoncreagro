...
Partial Public Class FrmListaOrdenesCompraPorRecepcionar
    ...
    '''<summary>
    '''Control odsOcEnviadasPorRecepcionar.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents odsOcEnviadasPorRecepcionar As Global.System.Web.UI.WebControls.ObjectDataSource
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents Comprar As Global.Telerik.Web.UI.RadWindow
