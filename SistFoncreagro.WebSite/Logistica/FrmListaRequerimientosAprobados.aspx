<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmListaRequerimientosAprobados.aspx.vb" Inherits="SistFoncreagro.WebSite.FrmListaRequerimientosAprobados" %>
...
<script type="text/javascript">
    ...
    <div style="width: 931px; margin-left: 0px">
        <fieldset>
           <legend style="font-family: Arial; font-size: 12px; width: 251px;">Requerimientos de Compra 
                    Aprobados</legend>
    ...
    <Columns>
        <telerik:GridTemplateColumn UniqueName="TemplateColum1" AllowFiltering="False" 
         ...
         <ItemTemplate>
          ...
          PostBackUrl='<%# "FrmRequerimientoEditarGenerarOc.aspx?IdReq=" & Eval("IdRequerimiento") & "&accion=1" %>'
...
<HeaderContextMenu CssClass="GridContextMenu GridContextMenu_Default"></HeaderContextMenu>
                ...
                <asp:ObjectDataSource ID="odsRequerimientos" runat="server" 
                    SelectMethod="GetAllFromRequerimientosAprobadosByIdComprador" 
                    TypeName="SistFoncreagro.BussinesLogic.RequerimientoBL" 
                OldValuesParameterFormatString="original_{0}">
                    <SelectParameters>
                        <asp:SessionParameter Name="IdPersonaComprador" SessionField="IdUser" 
                            Type="Int32" />
                    </SelectParameters>
