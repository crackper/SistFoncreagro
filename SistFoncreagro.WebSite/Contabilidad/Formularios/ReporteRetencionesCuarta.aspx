<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteRetencionesCuarta.aspx.vb" Inherits="SistFoncreagro.WebSite.ReporteRetencionesCuarta" %>
...
<head id="Head1" runat="server">
    <title>Certificado de Retenciones de Cuarta Categoria</title>
    ...
    <div style="background-color: #FFFFFF" >
        <table align="center" class="tabla6">
            ...
            ParametersAreaVisible="False" ProgressText="Generando Vista Preliminar..." 
               Width="770px" BorderStyle="None" BorderWidth="1px" ShowHistoryButtons="False" 
