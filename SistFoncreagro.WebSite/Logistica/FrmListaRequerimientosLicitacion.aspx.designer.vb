...
Partial Public Class FrmListaRequerimientosLicitacion
    ...
    '''<summary>
    '''Control odsRequerimientos.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents odsRequerimientos As Global.System.Web.UI.WebControls.ObjectDataSource
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents VentanaReporte As Global.Telerik.Web.UI.RadWindow
