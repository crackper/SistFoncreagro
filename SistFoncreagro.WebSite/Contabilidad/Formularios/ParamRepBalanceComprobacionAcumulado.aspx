<%@ Page Title="Balance de Comprobación Acumulado" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contabilidad/MasterPageContabilidad.master" CodeBehind="ParamRepBalanceComprobacionAcumulado.aspx.vb" Inherits="SistFoncreagro.WebSite.ParamRepBalanceComprobacionAcumulado" %>
                ...
                <table class="fondoTabla" style="background-color: #0C3B2A; color: #FFFFFF;">
                    <tr class="Titulos">
                        <td class="Titulos" style="font-family: Arial; font-size: 10pt">
                            &nbsp;Parametros para mostrar el REPORTE DEL BALANCE DE COMPROBACIÓN acumulado</td>
                        <td>
                            &nbsp;</td>
