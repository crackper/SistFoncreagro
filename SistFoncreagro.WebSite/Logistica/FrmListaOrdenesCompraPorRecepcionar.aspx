<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmListaOrdenesCompraPorRecepcionar.aspx.vb" Inherits="SistFoncreagro.WebSite.FrmListaOrdenesCompraPorRecepcionar" %>
   ...
   <Columns>
        <telerik:GridTemplateColumn UniqueName="TemplateColumn" AllowFiltering="False">
         <ItemTemplate>
          ...
          PostBackUrl='<%# "FrmOrdenCompraPorRecepcionar.aspx?IdOrdenCompra=" & Eval("IdOrdenCompra") & "&tip=1" %>'
...
<HeaderContextMenu CssClass="GridContextMenu GridContextMenu_Default"></HeaderContextMenu>
            ...
            <asp:ObjectDataSource ID="odsOcEnviadasPorRecepcionar" runat="server" 
                SelectMethod="GetAllFromOrdenCompraControlPatrimonial" 
