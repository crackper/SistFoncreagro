<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FrmListaOrdenesCompraLicitacion.aspx.vb" Inherits="SistFoncreagro.WebSite.FrmListaOrdenesCompraLicitacion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="width: 931px; margin-left: 0px">
        <fieldset>
           <legend style="font-family: Arial; font-size: 12px; width: 135px;">Órdenes de Compra</legend>
...
<MasterTableView datasourceid="SqlDataSource1" pagesize="25" DataKeyNames="IdRequerimiento">
    ...
    <Columns>
        <telerik:GridTemplateColumn UniqueName="TemplateColumn" AllowFiltering="False">
         <ItemTemplate>
          ...
          PostBackUrl='<%# "FrmOrdenCompraEditar.aspx?IdOrdenCompra=" & Eval("IdOrdenCompra") %>'
        ...
        <telerik:GridBoundColumn DataField="RazonSocialD" 
            ...
            <ItemStyle Width="300px" HorizontalAlign="Center" Font-Size="8pt" />
        </telerik:GridBoundColumn>
...
<HeaderContextMenu CssClass="GridContextMenu GridContextMenu_Default"></HeaderContextMenu>
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                       ...
                       SelectCommand="GetAllFromOcByIdReq" SelectCommandType="StoredProcedure">
                       <SelectParameters>
                           <asp:QueryStringParameter Name="IdReq" QueryStringField="id" Type="Int32" />
                       </SelectParameters>
                   </asp:SqlDataSource>
                </div>
                <asp:ObjectDataSource ID="odsRequerimientos" runat="server" 
                    SelectMethod="GetAllFromOrdenCompraByIdComprador" 
