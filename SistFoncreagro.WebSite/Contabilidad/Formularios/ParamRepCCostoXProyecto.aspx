<%@ Page Title="Centros de Costos por Proyectos" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contabilidad/MasterPageContabilidad.master" CodeBehind="ParamRepCCostoXProyecto.aspx.vb" Inherits="SistFoncreagro.WebSite.ParamRepCCostoXProyecto" %>
                ...
                <table class="fondoTabla" style="background-color: #0C3B2A; color: #FFFFFF;">
                    <tr class="Titulos">
                        <td class="Titulos" style="font-family: Arial; font-size: 10pt">
                            &nbsp;PARÁMETROS PARA MOSTRAR los centros de costos</td>
                        <td>
                            &nbsp;</td>
