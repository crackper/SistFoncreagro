...
Public Class ListaValidarMuebles
    ...
    Protected Sub RadGrid1_ItemCommand(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.ItemCommand
        ...
        ElseIf e.CommandName = "Editar" Then
            ...
            cadena_java = "<script type='text/javascript'> " & _
                                           " radopen('FrmValidarMueble.aspx?IdBienMueble=" + id.ToString + "','Formulario'); " & _
                                           Chr(60) & "/script>"
    ...
    Protected Sub RadAjaxManager1_AjaxRequest(ByVal sender As Object, ByVal e As Telerik.Web.UI.AjaxRequestEventArgs) Handles RadAjaxManager1.AjaxRequest
        If e.Argument = "Validar" Then
            If BienMuebleBl.GetBIENMUEBLEByIdBienMueble(Me.HiddenField1.Value).Estado = "S" Then
                Dim cadena_java As String = _
                                         "<script type='text/javascript'> " & _
                                         " if (confirm('¡Debe validar el Bien!')) { radopen('FrmValidarMueble.aspx?IdBienMueble=" + Me.HiddenField1.Value + "','Formulario'); }  " & _
                                         Chr(60) & "/script>"
    ...
    Protected Sub RadGrid1_PreRender(ByVal sender As Object, ByVal e As EventArgs) Handles RadGrid1.PreRender
        If (Not Page.IsPostBack) Then
            RadGrid1.MasterTableView.FilterExpression = "(Estado LIKE '%Sin Validar%' and Tipo LIKE '%Activo%') "
            Dim column As GridColumn = RadGrid1.MasterTableView.GetColumn("Estado")
            Dim column1 As GridColumn = RadGrid1.MasterTableView.GetColumn("Tipo")

            column.CurrentFilterFunction = GridKnownFunction.Contains
            column.CurrentFilterValue = "Sin Validar"
            column1.CurrentFilterFunction = GridKnownFunction.Contains
            column1.CurrentFilterValue = "Activo"
