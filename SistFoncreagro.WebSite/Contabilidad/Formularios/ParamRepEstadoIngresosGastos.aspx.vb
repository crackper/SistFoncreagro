Public Class ParamRepEstadoIngresosGastos
    ...
    Protected Sub ImageButton1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton1.Click
        ...
        cadena_java = "<script type='text/javascript'> " & _
                                     " window.open('ReporteEstadoIngresosGastos.aspx?FechaFin=" + Me.RadDatePicker1.SelectedDate.ToString + "&idProyecto=" + IdProyecto.ToString + "&tipo=" + Me.RadComboBox4.SelectedValue.ToString + "' ); " & _
                                     Chr(60) & "/script>"
