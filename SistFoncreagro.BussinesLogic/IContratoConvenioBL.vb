...
Public Interface IContratoConvenioBL
    ...
    Function GetContratosConveniosUltimoByIdPeriodoLaboral(ByVal idPeriodoLaboral As Int32, ByVal argContrato As ArgumentosContrato) As ContratoConvenio
