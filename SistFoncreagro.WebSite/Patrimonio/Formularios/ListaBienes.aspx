<%@ Page Title="Lista de Bienes Muebles" Language="vb" AutoEventWireup="false" MasterPageFile="~/Patrimonio/MasterPagePatrimonio.master" CodeBehind="ListaBienes.aspx.vb" Inherits="SistFoncreagro.WebSite.ListaBienes" %>
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        ...
        <telerik:GridBoundColumn DataField="CodigoReferencia" 
            FilterControlAltText="Filter column column" HeaderText="Cod. Ref." UniqueName="column" 
        ...
        <telerik:GridBoundColumn AutoPostBackOnFilter="True" 
            CurrentFilterFunction="Contains" DataField="IdBienMueble" 
            DataType="System.Int32" FilterControlAltText="Filter IdBienMueble column" 
            HeaderText="IdBienMueble" ShowFilterIcon="False" SortExpression="IdBienMueble" 
...
<HeaderContextMenu CssClass="GridContextMenu GridContextMenu_Default"></HeaderContextMenu>
    ...
    <telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel1" Runat="server" 
        ...
        SelectCommand="GetAllFromBIENMUEBLEDetallado" 
