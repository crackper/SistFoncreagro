<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Dialog5.aspx.vb" Inherits="SistFoncreagro.WebSite.Dialog5" %>
...
<body onload="AdjustRadWidow();">
 ...
 <script type="text/javascript">
     ...
     function returnToParent() {
         ...
         //get the city's name 
         oArg.idOC = '<%= Request.QueryString("IdDetalleEje") %>';
    ...
    <table  width="300px">
        <tr>
            <td style="text-align: center" width="300px">
                Ingrese 
                el motivo de la cancelacion y haga clic en el botón &quot;Aceptar&quot;<br />
                <br />
            </td>
        </tr>
        <tr>
            <td style="text-align: center">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator28" runat="server" 
                    ...
                    ErrorMessage="¡Debe ingresar el Motivo!"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="text-align: center">
