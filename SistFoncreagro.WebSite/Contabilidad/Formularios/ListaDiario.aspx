<%@ Page Title="Lista de Comprobantes Diario" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contabilidad/MasterPageContabilidad.master" CodeBehind="ListaDiario.aspx.vb" Inherits="SistFoncreagro.WebSite.ListaDiario" %>
        ...
        <tr>
            <td>
                <table class="fondoTabla" style="background-color: #0C3B2A; color: #FFFFFF;">
                    <tr>
                        <td >
                            lista de comprobantes diario</td>
                        <td  >
                        </td>
...
<MasterTableView ClientDataKeyNames="IdSubdiario" CommandItemDisplay="Top" 
    ...
    <DetailTables>
        <telerik:GridTableView runat="server" ClientDataKeyNames="IdTransaccion" 
            DataKeyNames="IdTransaccion" DataSourceID="SqlTransaccion" 
...
<telerik:GridBoundColumn DataField="IdMoneda" HeaderText="M." UniqueName="IdMoneda" 
            ...
            <CommandItemSettings ExportToPdfText="Export to PDF" RefreshText="Refrescar" 
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="Proyecto" 
                    FilterControlAltText="Filter column2 column" HeaderText="Proyecto" 
                    UniqueName="column2">
                </telerik:GridBoundColumn>
                 <telerik:GridTemplateColumn 
                    FilterControlAltText="Filter TemplateColumn1 column" HeaderText="Estado" 
                ...
                <telerik:GridBoundColumn DataField="IdSubdiario" 
                    FilterControlAltText="Filter IdSubdiario column" UniqueName="IdSubdiario" 
                    Visible="False">
                </telerik:GridBoundColumn>
            </Columns>
            <EditFormSettings>
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        <telerik:GridBoundColumn DataField="IdSubDiario" DataType="System.Int32" 
            FilterControlAltText="Filter IdSubDiario column" HeaderText="Id" 
            SortExpression="IdSubDiario" UniqueName="IdSubDiario">
            <HeaderStyle Width="5%" />
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="Descripcion" 
            FilterControlAltText="Filter Descripcion column" HeaderText="SubDiario" 
...
<HeaderContextMenu CssClass="GridContextMenu GridContextMenu_Default"></HeaderContextMenu>
    ...
    <asp:ObjectDataSource ID="odsSubDiarios" runat="server" 
        SelectMethod="GetSUBDIARIOInTransaccion" 
    ...
    <asp:ObjectDataSource ID="odsTransaccion" runat="server" 
        SelectMethod="GetTRANSACCIONByAnioMesIdSubdiario" 
    ...
    <asp:SqlDataSource ID="SqlTransaccion" runat="server" 
        ConnectionString="<%$ ConnectionStrings:cnx %>" 
        SelectCommand="GetTRANSACCIONByAnioMesIdSubdiario1" 
